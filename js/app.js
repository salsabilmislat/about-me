...
function question2() {
    ...
    let language = prompt('Do I speak more than one language ?', 'answer with yes or no plz or Y/N');
...
let china = prompt('Do I Think that chinese language is the most hard lang. In the world ?', 'answer with yes or no plz or Y/N');
...
function question4() {
    ...
    let visit = prompt('Do you think that i visited china ?', 'answer with yes or no plz or Y/N');
...
function question5() {
    let City = prompt("Do you know the name of china capital city?", 'answer with yes or no plz or Y/N');
